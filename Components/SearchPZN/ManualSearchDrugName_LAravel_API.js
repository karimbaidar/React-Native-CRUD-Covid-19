...
export default class ManualSearchDrugName extends Component {
  ...
  componentDidMount = async () => {
    return fetch(
      //Fetching Data from Laravel Api :: Routes/api.php
      'http://192.168.0.31:8000/api/coins',
  ...
  render() {
    ...
    //https://ionicframework.com/docs/v3/ionicons/              This link is for icon names
    return (
      <Container>
                    ...
                    <Card>
                      <CardItem>
                        <Left>
                          ...
                          />
                          <Body>
                            <Text style={styles.textRegister1}>{item.degree}</Text>
                          </Body>
                        </Left>
                      </CardItem>
                      <CardItem cardBody>
